...
<head>
    ...
    <title>Tambah Promo Code - Admin</title>
...
<body>
    <header>
        <div style="display:flex;justify-content:space-between;align-items:center">
            <div style="font-weight:700;color:var(--accent)">Admin - Tambah Promo</div>
            <div>
            ...
            <form method="POST" action="{{ route('admin.promocodes.store') }}">
                ...
                <div class="row">
                    <div class="field">
                        ...
                        <input class="input" id="code" name="code" value="{{ old('code') }}" placeholder="HEMAT10" required>
                        <div class="muted">Akan disimpan sebagai UPPERCASE.</div>
                    </div>
                ...
                <div class="row">
                    <div class="field">
                        ...
                        <input class="input" id="value" name="value" type="number" min="1" value="{{ old('value') }}" placeholder="10" required>
                        <div class="muted">Percent: 10 artinya 10%. Fixed: 5000 artinya potong Rp 5.000.</div>
                    </div>

                    <div class="field">
                        <label for="usage_limit">Kuota (opsional)</label>
                        <input class="input" id="usage_limit" name="usage_limit" type="number" min="1" value="{{ old('usage_limit') }}" placeholder="100">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="field">
                        ...
                        <input class="input" id="min_purchase" name="min_purchase" type="number" min="0" value="{{ old('min_purchase') }}" placeholder="20000">
                    </div>

                    <div class="field">
                        <label for="max_discount">Max Diskon (opsional)</label>
                        <input class="input" id="max_discount" name="max_discount" type="number" min="0" value="{{ old('max_discount') }}" placeholder="20000">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="field">
                        ...
                        <input class="input" id="starts_at" name="starts_at" type="datetime-local" value="{{ old('starts_at') }}">
                    </div>
